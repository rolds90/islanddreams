<x-app-layout>
  ...
  <x-slot name="header">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Update Tour Information</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <form action="{{ route('admin.tour.update', $tour->slug) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <div class="fileinput fileinput-new {{ ($errors->has('image') ? 'is-invalid' : null) }}" data-provides="fileinput">
                            <div class="fileinput-new img-thumbnail" style="width: 200px; height: 150px;">
                              <img src="{{ $tour->image_url ?? 'http://placehold.it/200x150&text=No+Image' }}" alt="...">
                            </div>
                    ...
                    <div class="card card-primary">
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-12 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" id="name" name="name" value="{{ old('name') ?? $tour->name }}" class="form-control {{ ($errors->has('name') ? 'is-invalid' : null) }}" required autofocus>
                              <div class="invalid-feedback">
                                {{ $errors->first('name') }}
                              </div>
                            </div>
                          ...
                          <div class="col-12 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" id="location" name="location" value="{{ old('location') ?? $tour->location }}" class="form-control {{ ($errors->has('location') ? 'is-invalid' : null) }}" required>
                              <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="description" name="description" rows="3" placeholder="">{{ old('description') ?? $tour->description }}</textarea>
                          <div class="invalid-feedback">
                      ...
                      <div class="card-body">
                        <div class="form-group">
                          ...
                          <div class="input-group date" id="departuredatetime" data-target-input="nearest">
                            <input type="text" name="expire_at" value="{{ old('expire_at') ?? $tour->expire_at->format('m/d/Y g:i A') }}" class="form-control datetimepicker-input {{ ($errors->has('expire_at') ? 'is-invalid' : null) }}" data-target="#departuredatetime" required />
                        ...
                        <div class="row">
                          <div class="col-12 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="number" id="days" name="days" min="1" value="{{ old('days') ?? $tour->days }}" class="form-control {{ ($errors->has('days') ? 'is-invalid' : null) }}" required>
                              <div class="invalid-feedback">
                                {{ $errors->first('days') }}
                              </div>
                            </div>
                          ...
                          <div class="col-12 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="number" id="nights" name="nights" min="0" value="{{ old('nights') ?? $tour->nights }}" class="form-control {{ ($errors->has('nights') ? 'is-invalid' : null) }}"
                                required>
                              <div class="invalid-feedback">
                                {{ $errors->first('nights') }}
                              </div>
                      ...
                      <div class="card-body" id="dynamicAddItinerary">
                        ...
                        <div class="row py-2 border-top">
                          <div class="col-12 col-md-3">
                            <div class="form-group">
                              <label>Day</label>
                              <input type="number" name="ItineraryFields[{{ $loop->iteration }}][day]" value="{{ $loop->iteration }}" class="form-control" min="1" />
                            </div>
                          </div>
                          <div class="col-12 col-md-9">
                            <div class="form-group">
                              <label>Title</label>
                              <input type="text" name="ItineraryFields[{{ $loop->iteration }}][title]" value="{{ $itinerary->title }}" class="form-control" min="1" />
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="form-group">
                              <label>Description</label>
                              <textarea class="form-control" name="ItineraryFields[{{ $loop->iteration }}][description]" rows="3" placeholder="">{{ $itinerary->description }}</textarea>
                            </div>
                          </div>
                        </div>
                        @endforeach
                      ...
                      <div class="card-body" id="dynamicAddInclusion">
                        ...
                        <div class="row py-2 border-top">
                          <div class="col-12">
                            <div class="form-group">
                              <label>Description</label>
                              <button type="button" class="btn btn-outline-danger btn-sm float-right remove-inclusion">Remove</button>
                              <textarea class="form-control" name="InclusionFields[{{ $loop->iteration }}][description]" rows="3" placeholder="">{{ $inclusion->description }}</textarea>
                            </div>
                          </div>
                        </div>
                        @endforeach
    ...
    <div class="row mb-4">
      <div class="col-12">
        ...
        <input type="submit" value="Update Tour" class="btn btn-success float-right mr-2">
      </div>
    </div>
  </form>
  ...
  <x-slot name="script">
    ...
    <script>
      $(function(){
        ...
        var i = {{ $tour->itineraries->count() + 1 }};
          ...
          $("#dynamicAddItinerary").append(`
            <div class="row py-2 border-top">
              ...
              <div class="col-12 col-md-9">
                <div class="form-group">
                  <label>Title</label>
                  <input type="text" id="ItineraryFields[${i}][title]" name="ItineraryFields[${i}][title]" value="" class="form-control" min="1" />
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <label>Description</label>
                  <textarea class="form-control" id="ItineraryFields[${i}][description]" name="ItineraryFields[${i}][description]" rows="3" placeholder=""></textarea>
                </div>
              </div>
        ...
        var ii = {{ $tour->inclusions->count() + 1 }};
