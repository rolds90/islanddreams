<x-app-layout>
  ...
  <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group date" id="newsdate" data-target-input="nearest">
                    <input type="text" name="news_date" value="{{ old('news_date') }}"
          ...
          <div class="card-body text-center">
            <div class="form-group">
              <div class="input-group date" id="publishdate" data-target-input="nearest">
                <input type="text" name="publish_at" value="{{ old('publish_at') }}"
    ...
    <div class="row mb-4">
      <div class="col-12">
        ...
        <input type="submit" value="Create News" class="btn btn-success float-right mr-2">
      </div>
    </div>
  </form>
  ...
  <x-slot name="script">
    ...
    <script>
      $(function(){
        $('#newsdate').datetimepicker({ format: 'L' });
        $('#publishdate').datetimepicker({ icons: { time: 'far fa-clock' } });
