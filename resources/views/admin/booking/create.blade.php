  ...
  <form action="{{ route('admin.booking.store') }}" method="POST">
            ...
            <div class="row">
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id="origin" name="origin" class="form-control {{ ($errors->has('origin') ? 'is-invalid' : null) }}">
                  <div class="invalid-feedback">
                    {{ $errors->first('origin') }}
                  </div>
                </div>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id="destination" name="destination" class="form-control {{ ($errors->has('destination') ? 'is-invalid' : null) }}">
                  <div class="invalid-feedback">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <div class="input-group date" id="departuredatetime" data-target-input="nearest">
                <input type="text" name="travel_date" class="form-control datetimepicker-input {{ ($errors->has('travel_date') ? 'is-invalid' : null) }}" data-target="#departuredatetime" required />
            ...
            <div class="form-group">
              ...
              <div class="input-group date" id="arrivaldatetime" data-target-input="nearest">
                <input type="text" name="arrival_date" class="form-control datetimepicker-input {{ ($errors->has('arrival_date') ? 'is-invalid' : null) }}" data-target="#arrivaldatetime" required />
    ...
    <div class="row mb-4">
      <div class="col-12">
        ...
        <input type="submit" value="Create new Booking" class="btn btn-success float-right mr-2">
      </div>
    </div>
  </form>
