<x-app-layout>
  ...
  <x-slot name="header">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Udpdate Testimonial</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <form action="{{ route('admin.testimonial.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id="name" name="name" value="{{ old('name') ?? $testimonial->name }}" class="form-control {{ ($errors->has('name') ? 'is-invalid' : null) }}" required />
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group date" id="commentdate" data-target-input="nearest">
                    <input type="text" name="comment_at" value="{{ old('comment_at') ?? $testimonial->comment_at }}"
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="comment" name="comment" rows="3" placeholder="">{{ old('comment') ?? $testimonial->comment }}</textarea>
              <div class="invalid-feedback">
            ...
            <div class="form-group">
              <div class="fileinput fileinput-new {{ ($errors->has('image') ? 'is-invalid' : null) }}"
                ...
                <div class="fileinput-new img-thumbnail" style="width: 200px; height: 150px;">
                  <img src="{{ $testimonial->image_url ?? 'http://placehold.it/200x150&text=No+Image' }}" alt="...">
                </div>
    ...
    <div class="row mb-4">
      <div class="col-12">
        ...
        <input type="submit" value="Update Testimonial" class="btn btn-success float-right mr-2">
      </div>
    </div>
  </form>
  ...
  <x-slot name="script">
    ...
    <script>
      $(function(){
        $('#commentdate').datetimepicker({
          format: 'L',
          date: "{{ old('comment_at') ?? $testimonial->comment_at }}",
        });
      })
    </script>
  </x-slot>
