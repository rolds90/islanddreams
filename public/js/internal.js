$(document).ready(function(){
	...
	$('#gridview').on('click',function(e){
		e.preventDefault();
		$('.shoppage .row > .product-list').attr('class', 'product-layout product-grid col-lg-3 col-md-3 col-sm-4 col-xl-4');
	...
	$('#grid-view').on('click',function(){
		...
		$('.mainpage .row > .product-list').attr('class', 'product-layout product-grid col-lg-6 col-md-6 col-sm-6 col-xl-4');
		localStorage.setItem('display', 'grid');
	});
